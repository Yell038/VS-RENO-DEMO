...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'stage': //Week 1
				var bg:ParallaxSprite = new ParallaxSprite(-600, -200, Paths.image('stageback')).fixate(0, 0, 1, 1, 1, 1);
				add(bg);

				var stageFront:ParallaxSprite = new ParallaxSprite(-650, 600, Paths.image('stagefront')).fixate(0, 0, 0.6, 0.9, 1, 1, 'horizontal');
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['weekR_nomiss', 'ur_bad',
